    ...
    <div className="flex flex-col overflow-y-auto flex-1">
            ...
            <div className="overlay absolute top-0 left-0 flex w-full h-full bg-gradient-to-b from-transparent to-black  z-10 p-3">
                ...
                <div className="text flex flex-col mt-auto">
                    <p className='text-2xl uppercase font-black text-lime-400'>Blur strangers</p>
                    <p className='text-xs text-muted-foreground'>blurs everyone except the selected person</p>
                </div>
            </div>
